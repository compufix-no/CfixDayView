package no.compufix.cfixweekviewlibrary;
...
import static no.compufix.cfixweekviewlibrary.WeekViewUtil.*;
...
public class WeekView extends View {
   ...
   // public static final int SHORT_LENGTH = 1;
    ...
    //@Deprecated private int mDayNameLength = LONG_LENGTH;
    ...
    private void drawEventTitle(WeekViewEvent event, RectF rect, Canvas canvas, float originalTop, float originalLeft) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            StaticLayout.Builder sb= StaticLayout.Builder.obtain(bob,0,100, mEventTextPaint, availableWidth)
            ...
            do {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    StaticLayout.Builder sb= StaticLayout.Builder.obtain(bob,0,100, mEventTextPaint, availableWidth)
                            ...
                            .setEllipsizedWidth((int) (rect.right - originalLeft - mEventPadding * 2))
                            .setIncludePad (false);
                    textLayout = sb.build();
                }
                else {
        ...
        if (mDateTimeInterpreter == null) {
            mDateTimeInterpreter = new DateTimeInterpreter() {
                ...
                public String interpretDate(Calendar date) {
                    try {
                        //SimpleDateFormat sdf = mDayNameLength == SHORT_LENGTH ? new SimpleDateFormat("EEEEE M/dd", Locale.getDefault()) : new SimpleDateFormat("EEE M/dd", Locale.getDefault());
